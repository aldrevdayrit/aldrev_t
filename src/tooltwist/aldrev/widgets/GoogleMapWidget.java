...
//import tooltwist.aldrev.productionHelpers.GoogleMapProductionHelper;
...
public class GoogleMapWidget extends WbdWidgetController
{
	...
	//	instance.defineProperty(new WbdStringProperty("type", null, "Map Type", ""));
		instance.defineProperty(new WbdRadioTextProperty("type", null, "Map Type", "HYBRID, ROADMAP, SATELITE, TERRAIN", "HYBRID"));
	//	instance.defineProperty(new WbdRadioTextProperty("align", null, "Align", "left, center, right", ""));
