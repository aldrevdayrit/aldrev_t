...
import tooltwist.aldrev.productionHelpers.EditAddressProductionHelper;
 ...
 * editAddress
 */
public class EditAddressWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "editAddress_preview.html";
	private static final String SNIPPET_DESIGN = "editAddress_design.html";
	private static final String SNIPPET_PRODUCTION = "editAddress_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "editAddress_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "editAddress_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance,"editAddress_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, EditAddressProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(EditAddressProductionHelper.class.getName()));
			}
		}
