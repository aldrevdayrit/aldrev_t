...
//import tooltwist.aldrev.productionHelpers.MenuWidgetProductionHelper;
...
public class MenuWidgetWidget extends WbdWidgetController {
	...
	public void getCodeInserters(WbdGenerator generator, WbdWidget instance, UimData ud, CodeInserterList codeInserterList) throws WbdException {
		...
		if (mode == GenerationMode.DESIGN) {
			...
			// new
			// StylesheetCodeInserter(instance.miscellaneousFilePath(generator,
			// "menuWidget_cssHeader.css")),
			};
			...
			// new
			// JavascriptCodeInserter(instance.miscellaneousFilePath(generator,
			// "menuWidget_jsHeader.js")),
			...
			if (USE_PRODUCTION_HELPER) {
				...
				// MenuWidgetProductionHelper.class.getName(),
				// productionHelperParams));
				// codeInserterList.add(new
				// PageImportCodeInserter(MenuWidgetProductionHelper.class.getName()));
			}
		}
	...
	public void renderForJSP(WbdGenerator generator, WbdWidget instance, UimHelper ud, WbdRenderHelper rh) throws Exception {
		...
		rh.append("<ul>");
		System.out.println(currentNavpoint);
		...
		for (Navpoint nav: menuNav.getChildren()) {
			...
			boolean hasChildMenu = nav.hasChildren(true);
			
			rh.append("<li class='"+activeClass+" has-sub'><a href='"+navpointUrl+"'><span>"+label+"</span></a>");
			
			generateSub(hasChildMenu,rh,nav,navpointUrl,ud);
	...
	private void generateSub(boolean hasChildMenu,WbdRenderHelper rh, Navpoint nav,String navpointUrl,UimHelper ud) throws Exception{
		...
		if(hasChildMenu){
			...
			for(Navpoint subNav : nav.getChildren()){
				...
				String navId = subNav.getId();
				String subNavpointUrl = RoutingUIM.navpointUrl(ud, navId, AutomaticUrlParametersMode.NO_AUTOMATIC_URL_PARAMETERS);
				rh.append("<li class='has-sub'><a href='"+subNavpointUrl+"'><span>"+subLabel+"</span></a>");
