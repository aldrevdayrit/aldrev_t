...
import tooltwist.aldrev.productionHelpers.DynamicEmployeeListProductionHelper;
 ...
 * dynamicEmployeeList
 */
public class DynamicEmployeeListWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "dynamicEmployeeList_preview.html";
	private static final String SNIPPET_DESIGN = "dynamicEmployeeList_design.html";
	private static final String SNIPPET_PRODUCTION = "dynamicEmployeeList_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "dynamicEmployeeList_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "dynamicEmployeeList_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator,instance, "dynamicEmployeeList_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, DynamicEmployeeListProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(DynamicEmployeeListProductionHelper.class.getName()));
			}
		}
