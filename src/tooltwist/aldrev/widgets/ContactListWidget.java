...
import tooltwist.aldrev.productionHelpers.ContactListProductionHelper;
 ...
 * contactList
 */
public class ContactListWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "contactList_preview.html";
	private static final String SNIPPET_DESIGN = "contactList_design.html";
	private static final String SNIPPET_PRODUCTION = "contactList_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "contactList_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "contactList_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance,"contactList_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ContactListProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ContactListProductionHelper.class.getName()));
			}
		}
