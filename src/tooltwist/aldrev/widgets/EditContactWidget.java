...
import tooltwist.aldrev.productionHelpers.EditContactProductionHelper;
 ...
 * editContact
 */
public class EditContactWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "editContact_preview.html";
	private static final String SNIPPET_DESIGN = "editContact_design.html";
	private static final String SNIPPET_PRODUCTION = "editContact_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "editContact_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "editContact_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator,instance, "editContact_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
		else if (mode == GenerationMode.PRODUCTION || generator.getMode() == GenerationMode.CONTROLLER)
		{
			...
			CodeInserter[] arr = {
//				// Link to an external Javascript file
				new JavascriptLinkInserter("http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css"),
					
//				// Link to an external stylesheet
//				new StylesheetLinkInserter(cssUrl),
					
//				// Include a javascript snippet 
				new JavascriptCodeInserter(generator, instance, "editContact_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, EditContactProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(EditContactProductionHelper.class.getName()));
			}
		}
