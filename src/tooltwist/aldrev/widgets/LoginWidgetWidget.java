...
import tooltwist.aldrev.productionHelpers.LoginWidgetProductionHelper;
 ...
 * login widget
 */
public class LoginWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "loginWidget_preview.html";
	private static final String SNIPPET_DESIGN = "loginWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "loginWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "loginWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "loginWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "loginWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, LoginWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(LoginWidgetProductionHelper.class.getName()));
			}
		}
