...
//import tooltwist.aldrev.productionHelpers.EmployeeProductionHelper;
 ...
 * employee details
 */
public class EmployeeWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "employee_preview.html";
	private static final String SNIPPET_DESIGN = "employee_design.html";
	private static final String SNIPPET_PRODUCTION = "employee_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "employee_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "employee_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "employee_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, EmployeeProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(EmployeeProductionHelper.class.getName()));
			}
		}
