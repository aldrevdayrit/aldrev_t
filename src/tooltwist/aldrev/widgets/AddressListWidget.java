...
import tooltwist.aldrev.productionHelpers.AddressListProductionHelper;
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "addressList_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "addressList_jsHeader.js")),
