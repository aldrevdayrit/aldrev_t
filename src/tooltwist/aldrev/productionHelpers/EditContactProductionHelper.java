package tooltwist.aldrev.productionHelpers;
...
public class EditContactProductionHelper extends WbdProductionHelper
{
	...
	public EditContactProductionHelper(Properties prop)
	{
		super(prop);
	}
...
//		{
		...
		setEmployeeId(request.getParameter("employeeId"));
		
			// Select the data
			Xpc xpc = ud.getXpc();
			xpc.start("phinza.D.contactInfo", "select");
