...
<%@page import="tooltwist.aldrev.productionHelpers.LoginWidgetProductionHelper"%>
...
<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="LoginWidget" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	loginWidget
