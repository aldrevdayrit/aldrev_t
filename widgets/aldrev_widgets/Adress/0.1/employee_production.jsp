...
Home Number:  <input type="text" name="fName" id="fName" required/><br />
Cellphone Number:  <input type="text" name="mName" id="mName" required/><br />
Company Number:  <input type="text" name="lName" id="lName" required/><br />
